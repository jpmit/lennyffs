...
subroutine xpars(xpos,ypos,zpos,npar,nsurf,lboxx,lboxy,lboxz,zperiodic,ncut,&
                 nlinks,linkval,xps,nxtal)
  ...
  real(kind=db) :: sepx,sepy,sepz,sepsq,ncutsq,r,costheta,rh,phi,ylmr,ylmi
  real(kind=db) :: qnorm,lval,p5lboxx,p5lboxy,p5lboxz
